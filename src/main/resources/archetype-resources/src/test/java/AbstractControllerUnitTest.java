...
import ${package}.exception.${domainName}IdNotConsistentException;import ${package}.exception.${domainName}NotFoundException;import ${package}.exception.${domainName}NotPersistedException;
...
/**
 * Abstract Unit Test class for Unit testing Controllers.
 * 
...
public class AbstractControllerUnitTest {
	...
	private SimpleMappingExceptionResolver mapException(Class<? extends Exception> clazz, HttpStatus status) {
